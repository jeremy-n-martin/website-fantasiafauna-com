...
|---|---|---|---|---|
| `tank` | Tank | Quand un Tank est en jeu, les créatures adverses sont obligées de l'attaquer en priorité (sauf Ranged). | 24.0% (82/341) | ★★★ |
...
| `ranged` | Ranged | Attaque à distance : ignore les Tanks, peut cibler les créatures volantes, et n’encaisse jamais de riposte (Assassin + Sans riposte). | 19.6% (67/341) | ★★★ |

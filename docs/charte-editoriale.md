...
- Conserver les références et les appels de source dans les JSON de travail pour la vérification éditoriale, mais ne plus afficher les appels de citation ni les blocs « Sources et lectures » sur les pages publiques, conformément à la demande de l'utilisateur. Ne pas inventer d'URL, de citation ou de date. Ne pas recopier de longs passages de sources modernes.
